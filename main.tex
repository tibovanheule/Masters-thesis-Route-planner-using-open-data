...
\usepackage{pgfopts}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,arrows,external,decorations.pathmorphing,shadows}
...
%cover sheet
\includepdf{titel-67481258.pdf}
\include{chapters/abstract}
\includepdf[pages={-}]{Master_thesis__Extended_abstract(10).pdf}
